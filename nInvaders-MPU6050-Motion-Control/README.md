...
To achieve the project goals, the following packages must be included in the final image:
dropbear, ninvaders, i2c-tools, kernel-modules, kmod, ethtool,iproute2.
For this purpose, the IMAGE_INSTALL variable can be set in the local.conf file
---
